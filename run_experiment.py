...
policy = {"name": "e_greedy", "e": 0.3}

savedir = "results/2023-09-21"
os.makedirs(savedir, exist_ok=True)

def multi_func(i, Env, Agent, habituation, n_episodes, table_size, alpha, gamma, policy):
    env = Env()
