...
def plot(paths, paths_b, paths_d, paths_r, show_error, limit, savedir):
    ...
    if limit is not None:
        ax.set_ylim(0, limit)
    savepath = f"{savedir}/tds_{agent}_BM{bm_size1}toBM{bm_size2}.png" if limit is None else f"{savedir}/tds_{agent}_BM{bm_size1}toBM{bm_size2}_limit{limit}.png"
